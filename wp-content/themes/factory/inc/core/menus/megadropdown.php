...
class factorycommercegurus_primary_menu extends Walker_Nav_Menu {
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( strpos( $class_names, 'image-item-title' ) !== false ) {
			$description = '<img src="' . do_shortcode( $item->description ) . '" alt=" "/>';
		}
...
add_filter( 'wp_nav_menu_objects', 'factorycommercegurus_add_menu_parent_class' );

function factorycommercegurus_add_menu_parent_class( $items ) {
...
class factorycommercegurus_mobile_menu extends Walker_Nav_Menu {
