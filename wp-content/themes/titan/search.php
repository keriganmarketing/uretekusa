<?php titan_bunch_global_variable();
	...
	$layout = titan_set( $settings, 'search_page_layout', 'right' );
	$sidebar = titan_set( $settings, 'search_page_sidebar', 'blog-sidebar' );
	...
	$bg = titan_set($settings, 'search_page_header_img');
	$title = titan_set($settings, 'search_page_header_title');
?>
<!--Page Title-->  
            ...
            <div class="<?php echo esc_attr($classes);?>">
                ...
                <?php else : ?>
                	<div class="<?php echo esc_attr($classes);?> blog_post_area eco-search">
                        <p><?php esc_html_e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'titan' ); ?></p>
                        <div class="sidebar-wrapper">
                        	<div class="single-sidebar">
                        		<?php get_search_form('searchform3'); ?>
                        	</div>
                        </div>
                    </div>
                <?php endif; ?>
