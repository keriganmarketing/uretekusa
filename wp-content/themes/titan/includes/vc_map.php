...
//Services
titan_vc_map( array(
			"name" => esc_html__("bbPress Forums", 'titan'),
			"base" => "bbp-forum-index",
			"class" => "",
			"category" => esc_html__('Jollyall', 'titan'),
			"icon" => 'faqs' ,
			"params" => array(				
				array(
				   "type" => "textfield",
				   "holder" => "div",
				   "class" => "",
				   "heading" => esc_html__("Forum", 'titan'),
				   "param_name" => "forum",
				   "description" => ''
				),
...
$param = array(
  ...
  "holder" => "div",
  "class" => "",
  "heading" => esc_html__("Container", 'titan'),
  "param_name" => "container",
  "value" => array('Center Page'=>true),
  "description" => esc_html__("Choose whether you want to add a container before row or not.", 'titan')
);
