...
<div class="services-area row row-tb-15">
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="about-us-box">
            <figure class="embed-responsive embed-responsive-4by3 mb-15" data-bg-img="<?php echo esc_attr( get_the_post_thumbnail_url( get_the_ID() , "grandpoza-rectangular-sm-thumb" ) );?>">
