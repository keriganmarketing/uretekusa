...
<?php
	$args = fabrique_template_args( 'navbar-standard' );
			...
			<div class="fbq-navbar-wrapper">
				...
				<div class="fbq-navbar-content">
					<div class="fbq-navbar-content-inner">
						...
						<?php if ( ( 'left' === $opts['navbar_menu_position'] || 'center' === $opts['navbar_menu_position'] ) && !$opts['is_item'] && is_active_sidebar( 'fabrique-navbar-standard-right' ) ) : ?>
							<div class="fbq-widgets navbar-widgets right">
								<ul class="fbq-widgets-list">
									<?php dynamic_sidebar( 'fabrique-navbar-standard-right' ); ?>
								</ul>
							</div>
						<?php endif ;?>
