...
<?php
	$args = fabrique_template_args( 'navbar-split' );
						...
						<?php if ( !empty( $menu ) ) : ?>
							<div class="fbq-navbar-body">
								<div class="fbq-navbar-body-inner">
									...
									<?php if ( ( $opts['search_on'] || $opts['cart_on'] ) && 'split' === $opts['navbar_style'] ) : ?>
										<ul class="fbq-extra-menu">
											<?php if ( $opts['search_on'] ) : ?>
												<?php echo fabrique_escape_content( fabrique_template_menu_search() ); ?>
											<?php endif; ?>
											<?php if ( $opts['cart_on'] ) : ?>
												<?php echo fabrique_escape_content( fabrique_template_menu_cart() ); ?>
											<?php endif; ?>
										</ul>
									<?php endif; ?>
