...
<?php
	$args = fabrique_template_args( 'items/product' );
	$opts = fabrique_item_product_options( $args );
...
<?php if ( fabrique_is_woocommerce_activated() ) : ?>
	...
	<?php else : ?>
		<?php echo fabrique_get_dummy_template( esc_html__( 'product', 'fabrique' ), esc_html__( 'Shop is now empty.', 'fabrique' ) ); ?>
	<?php endif; ?>

<?php else : ?>
	<?php echo fabrique_get_dummy_template( esc_html__( 'product', 'fabrique' ), esc_html__( 'Please install and activate Woocommerce Plugin.', 'fabrique' ) ); ?>
<?php endif; ?>
