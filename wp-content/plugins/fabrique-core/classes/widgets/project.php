...
class Fabrique_Widget_Project extends Fabrique_Widget_Base
{
	protected function get_widget_options()
	{
		return array(
			'id' => 'fabrique_widget_project',
			'title' => esc_html__( 'Fabrique Project', 'fabrique-core' ),
			'widget_options' => array(
				'description' => esc_html__( 'Fabrique Project', 'fabrique-core' ),
	...
	public function widget( $args, $instance )
	{
		...
		if ( !empty( $instance['category_filter'] ) ) {
			$query_args['tax_query'] = array(
					array(
						'taxonomy' => 'fbq_project_category',
						'field'    => 'term_id',
						'terms'    => $instance['category_filter']
					),
			);
		}
		...
		if ( $query->have_posts() ) {
			while ( $query->have_posts() ) {
				...
				if ( 'on' === $instance['show_meta'] ) {
					$categories = fabrique_term_names( fabrique_get_taxonomy( 'fbq_project_category' ) );
	...
	public function form( $instance )
	{
		...
		$choices = array();
		$categories = get_terms( 'fbq_project_category', array( 'hide_empty' => false ) );
