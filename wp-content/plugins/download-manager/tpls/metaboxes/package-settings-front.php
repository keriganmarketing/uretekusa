...
<div id="package-settings" class="tab-pane active">
    <div id="version_row" class="form-group row">
        <div class="col-md-3"><?php echo __('Version:','wpdmpro'); ?></div>
    ...
    <div id="link_label_row" class="form-group row">
        <div class="col-md-3"><?php echo __('Link Label:','wpdmpro'); ?></div>
    ...
    <div id="stock_limit_row" class="form-group row">
        <div class="col-md-3"><?php echo __('Stock&nbsp;Limit:','wpdmpro'); ?></div>
    ...
    <div id="downliad_limit_row" class="form-group row">
        <div class="col-md-3"><?php echo __('Download&nbsp;Limit:','wpdmpro'); ?></div>
        <div class="col-md-9"><div class="input-group"><input size="10" class="form-control" type="text" name="file[download_limit_per_user]" value="<?php echo get_post_meta($post->ID,'__wpdm_download_limit_per_user', true); ?>" /><div class="input-group-addon">/ user</div></div></div>
    </div>

    <div id="download_count_row" class="form-group row">
        <div class="col-md-3"><?php echo __('Download&nbsp;Count:','wpdmpro'); ?></div>
    ...
    <div id="package_size_row" class="form-group row">
        <div class="col-md-3"><?php echo __('Package&nbsp;Size:','wpdmpro'); ?></div>
    ...
    <div id="access_row" class="form-group row">
        <div  class="col-md-3"><?php echo __('Allow Access:','wpdmpro'); ?></div>
        <div class="col-md-9">
    ...
    <div id="individual_file_download_row" class="form-group row">
        <div class="col-md-3"><?php echo __('Single File Download:','wpdmpro'); ?></div>
        <div class="col-md-9">
    ...
    <div id="cache_zip_row" class="form-group row">
        <div class="col-md-3"><?php echo __('Cache Zip File:','wpdmpro'); ?></div>
        <div class="col-md-9">


            <div id="eid">
                <input type="radio" value="-1" id="radio5" name="file[cache_zip]" <?php if(get_post_meta($post->ID,'__wpdm_cache_zip', true) == -1 || get_post_meta($post->ID,'__wpdm_cache_zip', true) == null) echo 'checked=checked';?> /> <label for="radio5"><?php _e("Use Global","wpdmpro"); ?> &nbsp; </label>
                <input type="radio" value="1" id="radio6" name="file[cache_zip]" <?php checked(get_post_meta($post->ID,'__wpdm_cache_zip', true),1);?> /> <label for="radio6"><?php _e("Enable","wpdmpro"); ?> &nbsp; </label>
                <input type="radio" value="0" id="radio7" name="file[cache_zip]" <?php checked(get_post_meta($post->ID,'__wpdm_cache_zip', true),0);?> /> <label for="radio7"><?php _e("Disable","wpdmpro"); ?></label>
    ...
    <div id="template_row" class="form-group row">
        <div class="col-md-3"><?php echo __('Link Template:','wpdmpro'); ?></div>
    ...
    <div id="page_template_row" class="form-group row">
        <div class="col-md-3"><?php echo __('Page Template:','wpdmpro'); ?></div>
        <div class="col-md-9"><?php
