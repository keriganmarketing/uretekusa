...
<div id="plupload-upload-ui" class="hide-if-no-js">
        <div id="drag-drop-area">
            <div class="drag-drop-inside">
                ...
                <p class="drag-drop-buttons"><input id="plupload-browse-button" type="button" value="<?php esc_attr_e('Select Files'); ?>" class="btn btn-default btn-xs" /></p>
            </div>
        </div>
    </div>
    ...
    if(get_option('__wpdm_chunk_upload',0) == 1){
        ...
        $plupload_init['max_file_size'] = $slimit.'b';
