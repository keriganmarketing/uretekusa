...
class WPDM_ListPackages extends WP_Widget {
    /** constructor */
    ...
    function form($instance) {
        ...
        <p>
            <select id="plob" style="margin-right: 5px" name="<?php echo $this->get_field_name('order_by'); ?>">
                ...
                <option value="download_count" <?php selected('download_count', $order_by); ?>>Downloads</option>
                <option value="package_size_b" <?php selected('package_size_b', $order_by); ?>>Package Size</option>
                <option value="view_count" <?php selected('view_count', $order_by); ?>>Views</option>
...
add_action('widgets_init', create_function('', 'return register_widget("WPDM_ListPackages");'));
