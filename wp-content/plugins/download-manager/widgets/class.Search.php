...
if(!class_exists('WPDM_SearchWidget')){
    ...
    class WPDM_SearchWidget extends WP_Widget {
        ...
        function widget($args, $instance) {
            ...
            echo "<div class='input-group'><input type=text class='form-control' name='q' /><span class='input-group-btn'><button class='btn btn-default'><i class='fa fa-search'></i> ".__("Search","wpdmpro")."</button></span></div><div class='clear'></div>";
            echo "</form></div>";
