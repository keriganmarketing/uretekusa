                 ...
                 <div class="panel panel-default">
                     ...
                     <div class="panel-body">
                         ...
                         <div class="form-group">
                             ...
                             <em class="note"><?php printf(__('The page where you used short-code %s', 'wpdmpro'),'<code>[wpdm_login_form]</code>'); ?></em>
                         </div>
                         ...
                         <div class="form-group">
                             ...
                             <em class="note"><?php printf(__('The page where you used short-code %s', 'wpdmpro'),'<code>[wpdm_reg_form]</code>'); ?></em>
                         </div>
                        ...
                        <div class="form-group">
                             <label for="__wpdm_user_dashboard"><?php echo __('Public Profile Page','wpdmpro'); ?></label><br/>
                             <?php wp_dropdown_pages(array('name' => '__wpdm_author_profile', 'id' => '__wpdm_author_profile', 'show_option_none' => __('None Selected', 'wpdmpro'), 'option_none_value' => '' , 'selected' => get_option('__wpdm_author_profile'))) ?><br/>
                             <em class="note"><?php printf(__('The page where you used short-code %s', 'wpdmpro'),'<code>[wpdm_user_profile]</code>'); ?></em>
                         </div>
                         ...
                         <div class="form-group"><hr/>
                             ...
                             <label><input style="margin: 0 10px 0 0" type="checkbox" name="__wpdm_disable_new_package_email" value="1" <?php checked(1, get_option('__wpdm_disable_new_package_email')); ?>><?php echo __('Disable New Package Notification Email','wpdmpro'); ?></label><br/>
                             <em><?php echo __('Check if you do not want to receive email notification when someone creates new package from frontend','wpdmpro'); ?></em>
                         </div>
                         ...
                         <div class="form-group"><hr/>
                             ...
                             <em><?php _e('Check this option if you want to enable pagination & search in file list where there are more than 30 files attached with a package','wpdmpro'); ?></em>
                             <br/>
                         ...
                         <div class="form-group"><hr/>
                             ...
                             <label><input style="margin: 0 10px 0 0" type="checkbox" <?php checked(get_option('__wpdm_ajax_popup',0),1); ?> value="1" name="__wpdm_ajax_popup"><?php _e('Load Lock Options Using Ajax','wpdmpro'); ?></label><br/>
                             <em><?php _e('Check this option if you want to load lock options in popover using ajax','wpdmpro'); ?></em>
                             <br/>
