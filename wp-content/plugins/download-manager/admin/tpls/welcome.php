...
<style>
    ...
    .w3eden .label.label-info{
        font-size: 11px;background: rgba(132, 111, 168, 0.38) !important; padding: 5px 10px !important;;border-radius: 2px !important;font-weight: 300;font-family: Roboto;letter-spacing: 1px;
    }
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="alert alert-progress text-center">
                    <a style="color: #ffffff;font-size: 12pt" href="https://www.wpdownloadmanager.com/download/verse-wordpress-theme-for-digital-shop/" target="_blank"><i class="fa fa-gift" style="margin-right: 7px"></i> Verse – Free WordPress Theme for Digital Shops, Get it now! </a>
                </div>
            ...
            <div class="col-md-12 lead">
                <h3>What's New?</h3>
                What new with WordPress Download Manager Pro v4.7.x:
            </div>

            <div class="col-md-4 r">

                <b>Chunk Upload Support</b>
                Helps you to override the http file upload limit from your server

            </div>
            <div class="col-md-4 r">
                <b>Expirable Download Link</b>
                Generate expirable download link with usage limit and expiry date
