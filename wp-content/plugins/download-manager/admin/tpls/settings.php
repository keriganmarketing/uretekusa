...
<div style="clear: both;"></div>
 ...
 <div class="panel panel-default" id="wpdm-wrapper-panel">
     <div class="panel-heading"><button type="submit" class="btn btn-default pull-right"><i class="sinc fa fa-save color-green"></i> &nbsp<?php _e("Save Settings","wpdmpro"); ?></button><h3 class="h"><i class="fa fa-cog color-purple" id="wdms_loading"></i>&nbsp;&nbsp;<?php _e("Download Manager Settings","wpdmpro"); ?></h3>
     </div>
...
<div class="alert alert-success" style="max-width: 300px !important;display: none;position: fixed; right: 15px;top: 100px;background: #ffffff !important;cursor: pointer" id="message"></div>
...
<br>
         ...
         <button type="submit" class="btn btn-info btn-lg"><i class="sinc fa fa-save"></i> &nbsp;<?php _e("Save Settings","wpdmpro"); ?></button>
...
jQuery(document).ready(function(){
    ...
    jQuery('body').on('click', '#message.alert-success', function () {
       jQuery(this).fadeOut();
    });
    ...
    jQuery('#wdm_settings_form').submit(function(){
       ...
       jQuery(this).ajaxSubmit({
        ...
        success: function(responseText, statusText, xhr, $form){
          jQuery('#message').html("<p>"+responseText+"</p>").fadeIn();
