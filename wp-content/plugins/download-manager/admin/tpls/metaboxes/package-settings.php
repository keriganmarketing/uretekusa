...
<ul class="nav nav-tabs">
    <li class="active"><a href="#package-settings" role="tab" data-toggle="tab"><?php echo __('Package Settings','wpdmpro'); ?></a></li>
    <li><a href="#lock-options" role="tab" data-toggle="tab"><?php echo __('Lock Options','wpdmpro'); ?></a></li>
    <li><a href="#package-icons" role="tab" data-toggle="tab"><?php echo __('Icons','wpdmpro'); ?></a></li>
    <?php 
...
<div id="package-settings" class="tab-pane active">
    <table cellpadding="5" id="file_settings_table" cellspacing="0" width="100%" class="table table-bordered table-hover">
        ...
        <tr id="link_label_row">
            <td><?php echo __('Link Label:','wpdmpro'); ?></td>
       ...
       <tr id="package_size_row">
        ...
        <tr id="access_row">
            ...
            <td>
                <select name="file[access][]"  data-placeholder="<?php _e("Who should be able to download?","wpdmpro"); ?>"  class="chzn-select role" multiple="multiple" id="access" style="min-width: 350px">
                    <?php
        ...
        <tr id="cache_zip_row">
            ...
            <td>
                ...
                <div id="eid">
                    <input type="radio" value="-1" id="radio4" name="file[cache_zip]" <?php if(get_post_meta($post->ID,'__wpdm_cache_zip', true) == -1 || get_post_meta($post->ID,'__wpdm_cache_zip', true) == null) echo 'checked=checked';?> /> <label for="radio4"><?php _e("Use Global","wpdmpro"); ?> &nbsp; </label>
                    <input type="radio" value="1" id="radio5" name="file[cache_zip]" <?php checked(get_post_meta($post->ID,'__wpdm_cache_zip', true),1);?> /> <label for="radio5"><?php _e("Enable","wpdmpro"); ?> &nbsp; </label>
                    <input type="radio" value="0" id="radio6" name="file[cache_zip]" <?php checked(get_post_meta($post->ID,'__wpdm_cache_zip', true),0);?> /> <label for="radio6"><?php _e("Disable","wpdmpro"); ?></label>
        ...
        <?php if(isset($_GET['post'])&&$_GET['post']!=''){ ?>
            <tr>
                ...
                <td><input type="text" readonly="readonly" value="<?php echo get_post_meta($post->ID, '__wpdm_masterkey', true); ?>"> <input type="checkbox" value="1" name="reset_key" /> <?php echo __('Regenerate Master Key for Download','wpdmpro'); ?> <i class="info fa fa-info" title="<?php echo __('This key can be used for direct download','wpdmpro'); ?>"></i></td>
            </tr>
        <?php } ?>
