...
<div class="wrap w3eden">
    ...
    <div class="panel panel-default" id="wpdm-wrapper-panel">
        <div class="panel-heading">
            <b><i class="fa fa-bar-chart-o color-purple"></i> &nbsp; <?php echo __('Download Statistics','wpdmpro'); ?></b>
        ...
        <ul id="tabs" class="nav nav-tabs nav-wrapper-tabs" style="padding: 60px 10px 0 10px;background: #f5f5f5">
            ...
            <li <?php if(isset($_GET['type'])&&$_GET['type']=='history'){ ?>class="active"<?php } ?>><a href='edit.php?post_type=wpdmpro&page=wpdm-stats&type=history'><?php echo __('Download History','wpdmpro'); ?></a></li>
