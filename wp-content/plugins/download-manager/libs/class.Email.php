...
class Email {
    ...
    public static function templates() {
        ...
        $templates   = array(
            ...
            'user-signup'          => array(
                ...
                'for'     => 'customer',
                'default' => array(
                    'subject'    => sprintf( __( 'Welcome to %s', 'wpdmpro' ), $sitename ),
                    'from_name'  => get_option( 'blogname' ),
                    'from_email' => $admin_email,
            ...
            'password-reset'       => array(
                ...
                'for'     => 'customer',
                'default' => array(
                    'subject'    => sprintf( __( 'Request to reset your %s password', 'wpdmpro' ), $sitename ),
                    'from_name'  => get_option( 'blogname' ),
                    'from_email' => $admin_email,
            ...
            'email-lock'           => array(
                'label'   => __( 'Email Lock Notification', 'wpdmpro' ),
                'for'     => 'customer',
                'default' => array(
                    'subject'    => __( 'Download [#package_name#]', 'wpdmpro' ),
                    'from_name'  => get_option( 'blogname' ),
                    'from_email' => $admin_email,
            ...
            'new-package-frontend' => array(
                ...
                'for'     => 'admin',
                'default' => array(
                    'subject'    => __( 'New Package is Added By [#name#]', 'wpdmpro' ),
                    'from_name'  => get_option( 'blogname' ),
                    'from_email' => $admin_email,
    ...
    public static function send( $id, $params ) {
        ...
        $headers     = apply_filters( "wpdm_email_headers_" . $id, $headers );
        $attachments = apply_filters( "wpdm_email_attachments_" . $id, array(), $params );
        wp_mail( $to, $template['subject'], $template['message'], $headers, $attachments );
    }
