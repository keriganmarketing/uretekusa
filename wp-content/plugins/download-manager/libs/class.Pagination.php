                                ...
                                if($lastpage > 1){
                                                ...
                                                if($this->page){
                                                                ...
                                                                if($this->page > 1)
                                                                                ...
                                                                                $this->pagination .= "<li><a href=\"".$this->get_pagenum_link($prev)."\" class=\"prev\" $rel >$p</a></li>";
                                                ...
                                                if ($lastpage < 7 + ($this->adjacents * 2)){//not enough pages to bother breaking it up
                                                                ...
                                                                for ($counter = 1; $counter <= $lastpage; $counter++){
                                                                                ...
                                                                                if ($counter == $this->page)
                                                                                                ...
                                                                                                $this->pagination .= "<li><a href=\"".$this->get_pagenum_link($counter)."\" $rel >$counter</a></li>";
                                                ...
                                                elseif($lastpage > 5 + ($this->adjacents * 2)){//enough pages to hide some
                                                                ...
                                                                if($this->page < 1 + ($this->adjacents * 2)){
                                                                                ...
                                                                                $this->pagination .= "<li><a href=\"".$this->get_pagenum_link($lpm1)."\" $rel >$lpm1</a></li>";

                                                                                $this->pagination .= "<li><a href=\"".$this->get_pagenum_link($lastpage)."\" $rel >$lastpage</a></li>";
                                                                ...
                                                                elseif($lastpage - ($this->adjacents * 2) > $this->page && $this->page > ($this->adjacents * 2)){
                                                                                ...
                                                                                $this->pagination .= "<li><a href=\"".$this->get_pagenum_link(1)."\" $rel >1</a></li>";

                                                                                $this->pagination .= "<li><a href=\"".$this->get_pagenum_link(2)."\" $rel >2</a></li>";
                                                ...
                                                if($this->page){
                                                                ...
                                                                if ($this->page < $counter - 1)
                                                                                ...
                                                                                $this->pagination .= "<li><a href=\"".$this->get_pagenum_link($next)."\" class=\"next\" $rel >$n</a></li>";
