...
<div id="ai1wmge-settings-modal" class="ai1wmge-modal ai1wmge-not-visible">
		...
		<div class="ai1wmge-file-browser">
			...
			<ul class="ai1wmge-file-list">
				<li
					...
					v-bind:class="{'ai1wmge-dir-selected': item === selectedItem || item.id === preselectedItemID}"
	...
	<div class="ai1wmge-modal-action">
		<p v-if="items === false">
			<span style="float: none;" class="spinner" v-bind:class="{ 'is-active': loading }"></span>
		</p>
		<p v-if="items === false">
