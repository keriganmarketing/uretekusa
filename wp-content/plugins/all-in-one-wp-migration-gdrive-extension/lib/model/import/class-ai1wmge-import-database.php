...
class Ai1wmge_Import_Database {
	...
	public static function execute( $params ) {
		...
		// Set refresh token
		update_option( 'ai1wmge_gdrive_token', $params['gdrive_token'] );

		// Set SSL mode
		update_option( 'ai1wmge_gdrive_ssl', $params['gdrive_ssl'] );

		// Unset refresh token
		unset( $params['gdrive_token'] );

		// Unset SSL mode
		unset( $params['gdrive_ssl'] );
